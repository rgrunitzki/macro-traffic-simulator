 ...
 * @author rgrunitzki
 */
public class DifferenceQLearning extends Driver {

    //previous state
    private Vertex prev_intersection;
    private QTable qtable;
    private RewardFunction rewardFunction = new DifferenceRewards();

    public DifferenceQLearning(int id, Vertex origin, Vertex destination, Graph G) {
