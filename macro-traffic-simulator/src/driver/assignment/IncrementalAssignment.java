 ...
 * @author rgrunitzki
 */
public class IncrementalAssignment extends Driver {

    private Route route;

    public IncrementalAssignment(int id, Vertex origin, Vertex destination, Graph G) {
...
//            Map<String, EdgeEntry> edgesMap = shortestPath.listEdgeToHashtable(this.graph.getEdges(), false);
            ...
            for (Edge e : this.graph.getEdges()) {
                edgesMap.put(e.toString(), new EdgeEntry(e, e.getAcumulatedCost()));
            }
